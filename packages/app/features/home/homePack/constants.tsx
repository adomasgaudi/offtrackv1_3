...
export const PROJECTS = [
    {
      ...
      imgSrc: images.goingofftrack.src,
      imgWidth: 200,
    ...
    },
    {
      ...
      imgSrc: images.submersioncards.src,
      imgWidth: 200,
